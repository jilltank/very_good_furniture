...
class StatesControllerTest < ActionController::TestCase
  ...
  test "should create state" do
    assert_difference('State.count') do
      post :create, state: { area: @state.area, capitol: @state.capitol, name: @state.name, population: @state.population }
    end
  ...
  test "should update state" do
    patch :update, id: @state, state: { area: @state.area, capitol: @state.capitol, name: @state.name, population: @state.population }
    assert_redirected_to state_path(assigns(:state))
  end
